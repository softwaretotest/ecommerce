...
export default function TabContent({ M_Class_Name }) {
    ...
    const field_counter = use_M_Store((state) => state.field_counter);
    const set_field_counter = use_M_Store((state) => state.set_field_counter);
        ...
        <>
            ...
            <div className="input-engine-container">
                ...
                {Object.entries(M_value).map(([fieldname, field_data]) => (
                    ...
                    >
                        {set_field_counter(field_counter + 1)}
