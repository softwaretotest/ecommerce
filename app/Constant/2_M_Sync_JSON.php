...
class M_Sync_JSON
{
    ...
    public static function syncAll(): void
    {
        ...
        echo "======================================================================\n";
        echo " [5] SYNCHRONIZATION PROCESS COMPLETED SUCCESSFULLY                   \n";
        echo "======================================================================\n\n";
    }
    ...
    {
        echo "----------------------------------------------------------------------\n";
        echo "[4.1] Processing JSON to PHP generation for {$sourceFile} using {$jsonFile}\n";
        echo "----------------------------------------------------------------------\n\n";
    }
    ...
    {
        echo "----------------------------------------------------------------------\n";
        echo "[4.2] Processing Entities JSON to PHP generation using {$jsonFile}\n";
        echo "----------------------------------------------------------------------\n\n";
    }
}
