...
class f
{
    ...
    public const NAME = ['name', [d::DECIMAL, 2, 2], u::TEXT, cud::REQUIRED];
    public const PRICE = ['price', [d::DECIMAL, 10, 2], u::NUMBER, [cd::DEFAULT, 0], s::CURRENCY];
    public const STOCK = ['stock', [d::DECIMAL, 7, 3], u::NUMBER, [cd::DEFAULT, 0], cud::REQUIRED];
    public const IS_ACTIVE = ['is_active', d::INTEGER, u::SELECT, [cd::DEFAULT, 0], cd::NULLABLE];
